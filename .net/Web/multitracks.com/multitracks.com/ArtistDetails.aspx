        ...
        <div class="wrapper mod-standard mod-gray">
            <div class="details-banner">
                ...
                <div class="details-banner--hero">
                    <asp:Image ID="imageHero" runat="server" ImageUrl="" class="details-banner--hero--img"/>


                </div>
                <div class="details-banner--info">
                    <a href="#" class="details-banner--info--box">
                        <asp:Image ID="imageSmall" runat="server" ImageUrl="" class="details-banner--info--box--img" alt="alt"/>
                    </a>
                    <h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#"><asp:Label runat="server" ID="bandName"></asp:Label></a></h1>
                </div>
            </div>
                ...
                <main class="discovery--section">
                    ...
                    <section class="standard--holder">
                        ...
                        <div class="artist-details--biography biography">
                            ...
                            <asp:Label runat="server" ID="restBio" Visible="false"></asp:Label>
                            <p></p>
                            <asp:LinkButton runat="server" OnClick="readMore" ID="lbReadMore">Read More...</asp:LinkButton>
